module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    (function findMatchingRecords(proceed) {
      ...
      mongoCollection.find(mongoWhere).toArray().then(function findCb(nativeResult) {
      ...
      mongoCollection.deleteMany(secondaryMongoWhere).then(function deleteCb() {
        if (!isFetchEnabled) {
      ...
      }).catch(function (err) { return exits.error(err); }); // </ mongoCollection.deleteMany >
