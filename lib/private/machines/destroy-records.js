module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    (function findMatchingRecords(proceed) {
      ...
      (function(iifeDone) {mongoCollection.find(mongoWhere).toArray().then(function findCb(nativeResult) { iifeDone(null, nativeResult);}).catch(function(err) { iifeDone(err, null);});})(function findCb(err, nativeResult) {
