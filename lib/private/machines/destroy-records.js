module.exports = require('machine').build({
  ...
  exits: {
    ...
    success: {
      ...
      outputDescription: 'The `records` key is either `null` OR (if `fetch:true`) an array of physical records that were destroyed.  The `meta` key is reserved for passing back adapter-specific information to userland and/or Waterline.',
