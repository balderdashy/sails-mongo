module.exports = {
  ...
  inputs: {
    ...
    connectionString: {
      ...
      moreInfoUrl: 'https://sailsjs.com/documentation/reference/configuration/sails-config-datastores#?the-connection-url',
  ...
  fn(inputs, exits) {
    ...
    NodeMongoDBNativeLib.MongoClient.connect(mongoUrl, _clientConfig, (err, client) => {
      if (err) {
