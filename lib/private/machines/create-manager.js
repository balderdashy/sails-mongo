module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    // http://mongodb.github.io/node-mongodb-native/6.3/classes/MongoClient.html#connect
    (function(iifeDone){ NodeMongoDBNativeLib.MongoClient.connect(mongoUrl, _clientConfig).then(function(client){ iifeDone(null, client);}).catch(function(err) { iifeDone(err, null);});})(function(err, client){
      if (err) {
