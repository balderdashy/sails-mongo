module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    (function findMatchingIdsMaybe(proceed) {
      ...
      (function(iifeDone) { mongoCollection.find(mongoWhere, projection).toArray().then(function(nativeResult) { iifeDone(null, nativeResult);}).catch(function(err) { iifeDone(err, null);});})(function findCb(err, nativeResult) {
      ...
      (function(iifeDone) { mongoCollection.updateMany(secondaryMongoWhere, { '$set': s3q.valuesToSet }).then(function() { iifeDone();}).catch(function(err) { iifeDone(err);});})(function(err) {
        if (err) {
        ...
        (function(iifeDone) { mongoCollection.find(secondaryMongoWhere).toArray().then(function(phRecords) { iifeDone(null, phRecords);}).catch(function(err) { iifeDone(err, null);});})(function(err, phRecords) {
          if (err) { return exits.error(err); }
