...
module.exports = function buildMongoWhereClause(whereClause, WLModel, meta) {
  ...
  var mongoQueryFilter = (function recurse(branch) {
    ...
    if (constraintColumnName === pkColumnName && (!meta || !meta.collectionsNotUsingObjectIds || !_.contains(meta.collectionsNotUsingObjectIds, WLModel.identity))) {
      ...
      _.each(WLModel.attributes, function (attrDef /*, attrName */) {
        ...
        if (constraintColumnName === attrDef.columnName && (!meta || !meta.collectionsNotUsingObjectIds || !_.contains(meta.collectionsNotUsingObjectIds, attrDef.model))) {
          doCompareAsObjectIdIfPossible = true;
        }
      });
    }
