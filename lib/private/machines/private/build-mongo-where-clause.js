...
module.exports = function buildMongoWhereClause(whereClause, WLModel, meta) {
  ...
  var mongoQueryFilter = (function recurse(branch) {
    ...
    if (constraintColumnName === pkColumnName && (!meta || !meta.mongoCollectionsNotUsingObjectIds || !_.contains(meta.mongoCollectionsNotUsingObjectIds, WLModel.identity))) {
      ...
      _.each(WLModel.attributes, function (attrDef /*, attrName */) {
        ...
        if (constraintColumnName === attrDef.columnName && (!meta || !meta.mongoCollectionsNotUsingObjectIds || !_.contains(meta.mongoCollectionsNotUsingObjectIds, attrDef.model))) {
          doCompareAsObjectIdIfPossible = true;
        }
      });
    }
