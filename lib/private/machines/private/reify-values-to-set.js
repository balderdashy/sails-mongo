...
module.exports = function reifyValuesToSet(valuesToSet, WLModel, meta) {
  ...
  var useObjectIds = !meta || !meta.mongoCollectionsNotUsingObjectIds || !_.contains(meta.mongoCollectionsNotUsingObjectIds, WLModel.identity);
  ...
  _.each(WLModel.attributes, function (attrDef, attrName) {
    ...
    if (!meta || !meta.mongoCollectionsNotUsingObjectIds || !_.contains(meta.mongoCollectionsNotUsingObjectIds, attrDef.model)) {
      try {
