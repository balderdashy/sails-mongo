...
module.exports = function reifyValuesToSet(valuesToSet, WLModel, meta) {
  ...
  var useObjectIds = !meta || !meta.collectionsNotUsingObjectIds || !_.contains(meta.collectionsNotUsingObjectIds, WLModel.identity);
  ...
  _.each(WLModel.attributes, function (attrDef, attrName) {
    ...
    if (!meta || !meta.collectionsNotUsingObjectIds || !_.contains(meta.collectionsNotUsingObjectIds, attrDef.model)) {
      try {
