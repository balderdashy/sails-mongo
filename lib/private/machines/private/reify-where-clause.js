 ...
 */
module.exports = function reifyWhereClause(whereClause, WLModel, meta) {
  ...
  var mongoQueryFilter = (function recurse(branch) {
    ...
    if (true || meta && meta.useObjectIds) {
      // ^^TODO: remove the `true ||` above (Temporarily leaving it in to make sure everything works)
