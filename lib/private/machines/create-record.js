module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    (function(iifeDone){ mongoCollection.insertOne(s3q.newRecord).then(function(nativeResult) { iifeDone(null, nativeResult);}).catch(function(err){ iifeDone(err, null);});})(function(err, nativeResult) {
      ...
      (function(iifeDone) { mongoCollection.findOne({ _id: nativeResult.insertedId }).then(function(phRecord) { iifeDone(null, phRecord);}).catch(function(err) { iifeDone(err, null);});})(function(err, phRecord) {
        if (err) {
          return exits.error(err);
        }
        try {
