module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    (function(iifeDone) { mongoCollection.countDocuments(mongoWhere).then(function(nativeResult) { iifeDone(null, nativeResult);}).catch(function(err) { iifeDone(err, null);});})(function countCb(err, nativeResult) {
