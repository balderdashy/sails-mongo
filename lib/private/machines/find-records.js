module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    (function(iifeDone) { mongoDeferred.toArray().then(function(nativeResult) { iifeDone(null, nativeResult);}).catch(function(err) { iifeDone(err, null);});})(function findCb(err, nativeResult) {
