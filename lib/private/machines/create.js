module.exports = {
  ...
  inputs: {
    ...
    models: {
      description: 'A dictionary containing all known physical model definitions, keyed by model identity.',
      required: true,
      example: '==='//e.g. `{ pet: {attributes:{...}, tableName: 'sack_of_pets', identity: 'pet'} }`
    },
