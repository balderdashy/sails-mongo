 ...
 * Example usage:
 * ```
 * create: buildStdAdapterMethod(helpCreate, WLDriver, registeredDsEntries, registeredDryModels),
 * ```
 *
 * > NOTE:
 * > This is a stopgap.
 ...
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
module.exports = function buildStdAdapterMethod (machineDef, WLDriver, registeredDsEntries, registeredDryModels) {
