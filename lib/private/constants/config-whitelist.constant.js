...
module.exports = [
  ...
  // Connection Options:
  'poolSize', 'autoReconnect', 'auto_reconnect', 'noDelay', 'keepAlive', 'keepAliveInitialDelay', 'connectTimeoutMS',
  ...
  'appname', 'loggerLevel', 'logger', 'authMechanism', 'compression',
  'fsync', 'minSize', 'numberOfRetries', 'readPreferenceTags'
