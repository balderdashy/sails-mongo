      ...
      success: function (report) {
        try {
          ...
          _.each(physicalModelsReport, function(phModelInfo){
            ...
            registeredPhModels[phModelInfo.identity] = phModelInfo;
            ...
            //       { type: 'string',
            //         columnName: '_id',
            //         autoMigrations: { columnType: 'integer', autoIncrement: true, unique: true } },
            //      first_name:
            //       { type: 'string',
            //         autoMigrations: { columnType: 'varchar' },
            ...
            //      age:
            //       { type: 'number',
            //         autoMigrations: { columnType: 'integer' },
            //         columnName: 'age' },
            //      obj:
            //       { type: 'json',
            //         autoMigrations: { columnType: 'json' },
            //         columnName: 'obj' },
            //      status:
            //       { type: 'boolean',
            //         autoMigrations: { columnType: 'boolean' },
            //         columnName: 'status' },
            //      avatar:
            //       { type: 'ref',
            //         autoMigrations: { columnType: 'text' },
            //         columnName: 'avatar' },
            //      sort:
            //       { type: 'json',
            //         autoMigrations: { columnType: 'json' },
            ...
            //       { type: 'number',
            //         autoUpdatedAt: true,
            //         autoMigrations: { columnType: 'bigint' },
