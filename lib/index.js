...
module.exports = {
   ...
   */
  createManager: WLDriver.createManager,
   ...
   */
  destroyManager: WLDriver.destroyManager,
   ...
   */
  getConnection: WLDriver.getConnection,
   ...
   */
  releaseConnection: WLDriver.releaseConnection,
