...
module.exports = {
      ...
      success: function (report) {
        try {
          ...
          _.each(physicalModelsReport, function(phModelInfo){
            ...
            if (registeredPhModels[phModelInfo.identity]) {
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  create: buildStdAdapterMethod(require('./private/machines/create-record'), WLDriver, registeredDsEntries, registeredPhModels),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  createEach: buildStdAdapterMethod(require('./private/machines/create-each-record'), WLDriver, registeredDsEntries, registeredPhModels),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  update: buildStdAdapterMethod(require('./private/machines/update-records'), WLDriver, registeredDsEntries, registeredPhModels),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  destroy: buildStdAdapterMethod(require('./private/machines/destroy-records'), WLDriver, registeredDsEntries, registeredPhModels),
