...
module.exports = {
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  create: buildStdAdapterMethod(require('./private/machines/create'), WLDriver, registeredDsEntries, registeredPhModels, function __handleTransformingResultSync__(report) {
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  createEach: buildStdAdapterMethod(require('./private/machines/create-each'), WLDriver, registeredDsEntries, registeredPhModels, function __handleTransformingResultSync__(report) {
    // (`report.meta` is ignored)
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  update: buildStdAdapterMethod(require('./private/machines/update'), WLDriver, registeredDsEntries, registeredPhModels, function __handleTransformingResultSync__(report) { /*This is identical to createEach's and so was condensed for brevity -- see above for details.*/ if (_.isNull(report.records)) { return undefined; } return report.records; }),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  destroy: buildStdAdapterMethod(require('./private/machines/destroy'), WLDriver, registeredDsEntries, registeredPhModels, function __handleTransformingResultSync__(report) { /*This is identical to createEach's and so was condensed for brevity -- see above for details.*/ if (_.isNull(report.records)) { return undefined; } return report.records; }),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  find: buildStdAdapterMethod(require('./private/machines/find'), WLDriver, registeredDsEntries, registeredPhModels),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  count: buildStdAdapterMethod(require('./private/machines/count'), WLDriver, registeredDsEntries, registeredPhModels),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  sum: buildStdAdapterMethod(require('./private/machines/sum'), WLDriver, registeredDsEntries, registeredPhModels),
   ...
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
  avg: buildStdAdapterMethod(require('./private/machines/avg'), WLDriver, registeredDsEntries, registeredPhModels),
